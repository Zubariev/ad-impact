...
def fit_optimal_model(data: pd.DataFrame,
                     ...
                     handle_multicoll: bool = True) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logger.error(f"Base OLS model failed: {str(e)}")
    ...
    if has_autocorr and handle_autocorr:
        ...
        try:
            ...
            lagged_model = sm.OLS(y_lagged, X_lagged).fit()
            ...
            logger.error(f"Lagged dependent variable model failed: {str(e)}")
        ...
        try:
            ...
            logger.error(f"Newey-West model failed: {str(e)}")
    ...
    if has_multicol and handle_multicoll:
        ...
        try:
            ...
            pca_model = sm.OLS(model_data[target_col], X_pca_with_const).fit()
            ...
            logger.error(f"PCA regression failed: {str(e)}")
